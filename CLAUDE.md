...
- Visual style: editorial research-instrument treatment using a serif body font (Georgia/Times), deep navy (`#123449`), teal (`#176d86`), and restrained brass (`#b68742`) accents. Keep the pill-shaped badges/chips, generous whitespace, and minimal iconography (none currently; text and colour do the work) rather than introducing a competing visual language.
